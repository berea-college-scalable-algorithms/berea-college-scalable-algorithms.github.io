# CSC 386: Scalable Algorithms and Objects Website, Berea College
...
- Read Sections 11.03 of [Chapter 11 Indexing](https://canvas.instructure.com/courses/8407744)
- Work on [Binary Tree problems](https://leetcode.com/tag/binary-tree/).
...
- Read Sections 11.01 and 11.02 of [Chapter 11 Indexing](https://canvas.instructure.com/courses/8407744)
- Work on [Binary Tree problems](https://leetcode.com/tag/binary-tree/).
...
- Discussion of [TR1: Peerwise Review for Exam E1](https://docs.google.com/document/d/1yboGCOxNVY2PEyP34Q-UjQeBNJT_LJA43pqvjHB3w3U/edit?usp=sharing).
- Discussion of the first exam, E1.
- Discussion of the assigned Codewars katas.
...
- Discuss readings
- Begin [Exploring Queues in Java](https://docs.google.com/document/d/1WP-AFd7VKob6CoQecHNLURYNHbC8tywi9SCEQT8Siqc/edit?usp=sharing).
- When you finish the teamwork, work on the assigned Codewars katas.
...
- Begin [Exploring Arrays in Java](https://docs.google.com/document/d/1iwl8aGKsznkB6io_0HSPnzi8VvBDK3RrAO-P3mRFrIM/edit?usp=sharing). We will finish this next time.
- If you finish the teamwork, work on the assigned Codewars katas.
...
- Debug issues with textbook
- Work with partner on [Codewars](https://www.codewars.com/) problem. Search for "convert string to camel case". Then complete “convert string to camel case” kata in both C++ and Python.

### Day 2: Outside of class (due before class on Wednesday, January 17, 2024)

- Read [The first six sections in Java for Python Programmers](https://moodle.berea.edu/mod/lti/view.php?id=670958) for a potential reading quiz next class. Be sure you are logged in and do all activities to get credit!
...
- Bingo game
- Debrief on bingo strategy and how it relates to scalable algorithms
- [Codewars](https://www.codewars.com/) - sign-up and explore. Note that this use uses katas. ["Kata"](https://en.wikipedia.org/wiki/Kata) is a Japanese word meaning "form". It refers to a detailed choreographed pattern of martial arts movements made to be practiced alone. It can also be reviewed within groups and in unison when training. It is practiced in Japanese martial arts as a way to memorize and perfect the movements being executed.
- Get signed up for the textbook:
  - Search in your email for an email from Canvas. Push button in email. Then accept book and make password. Go to settings and set your timezone to Eastern. Explore the textbook a bit
...
- Complete [A01:Getting Started](https://docs.google.com/document/d/12cqAcs057RnS551WFxTgJiTPRnh_I57cV_dNpst6_ts/edit?usp=sharing) and submit to Moodle. Note that there are several tasks, some of which will take a bit of time:
  ...
  4. Read both sections of [Chapter 1: Review from Basic Data Structures](https://canvas.instructure.com/courses/8407744)
